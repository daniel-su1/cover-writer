...
app.get('/start/:id', (req, res) => {
    ...
    prompt = `{"model": "text-davinci-003", "prompt": "Write a cover letter for ${applicantName} whose resume is below: ${resumeText} who is applying for the ${job} position listed below: ${listing}", "temperature": 0.8, "max_tokens": 2000}`
